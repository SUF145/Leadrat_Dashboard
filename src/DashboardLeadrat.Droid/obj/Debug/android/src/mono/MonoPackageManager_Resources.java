...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "DashboardLeadrat.Android.dll" comes first in this list. */
		"DashboardLeadrat.Android.dll",
		"DashboardLeadrat.Core.dll",
		"DashboardLeadrat.UI.dll",
		"FormsViewGroup.dll",
